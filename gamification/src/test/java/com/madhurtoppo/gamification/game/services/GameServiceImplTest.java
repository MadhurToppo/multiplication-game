...
import com.madhurtoppo.gamification.game.services.GameService.GameResult;
...
class GameServiceImplTest {
    ...
    public void processCorrectAttemptTest() {
        ...
        given(badgeProcessor.processForOptionalBadge(10,
                                                     List.of(scoreCard),
                                                     attempt)).willReturn(Optional.of(BadgeType.LUCKY_NUMBER));
